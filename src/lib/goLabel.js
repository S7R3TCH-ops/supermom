export function getGoLabel(service, name = 'Sandra') {
  ...
  const pools = {
    ...
    morning:  ["First rescue of the day!", `Rise & shine, ${name}!`, "Morning hero: deployed", "First call up!"],
    general:  [`Cape up, ${name}!`, "Hero mode: activated", "She's on the case!", "On my way!", "Deploying now!", "Let's do this!"],
  };
